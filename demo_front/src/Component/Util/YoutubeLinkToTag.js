const YoutubeLinkToTag = (e) => {
    ...
    const regex = /(?:https?:\/\/)?(?:www\.|m\.)?(?:youtube\.com|youtu\.be)(?:\/(?:[\w\-]+\?v=|embed\/|v\/)?)([\w\-]+)(.*?)(?=<\/p>)/g;
    ...
    matches.forEach(match => {
        ...
        let tag = `<iframe width="100%" height="480" src="https://www.youtube.com/embed/${videoID}" frameborder="0" allow="accelerometer; autoplay; picture-in-picture; web-share" allowfullscreen ></iframe></br>`;
